...
type Querier interface {
	...
	GetPendingAmountByLease(ctx context.Context, leaseID uuid.UUID) (interface{}, error)
	GetTenantByCPF(ctx context.Context, cpf string) (Tenant, error)
	GetTenantByID(ctx context.Context, id uuid.UUID) (Tenant, error)
	GetTotalPaidByLease(ctx context.Context, leaseID uuid.UUID) (interface{}, error)
